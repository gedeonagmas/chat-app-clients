  ...
  return (
    <div className="fixed text-sm flex flex-col items-center justify-center h-full w-full">
      ...
      <div className="absolute w-[80%] sm:w-[65%] md:w-[45%] lg:[35%] z-30 flex flex-col gap-2 items-center justify-center rounded-lg bg-white py-10 px-4 h-auto xl:w-[30%]">
        <div className="h-auto text-lg font-extrabold py-2 w-[90%] px-2 rounded-md uppercase">
          login
        </div>
        {error && errorMessage && (
          <div className="h-auto text-gray-600 text-lg py-2 w-[90%] px-2 rounded-md">
            {errorMessage}
          </div>
        )}
        {success && (
          <div className="h-auto text-sm py-2 w-[70%] px-2 rounded-md">
            Login successful
          </div>
        )}
        <input
