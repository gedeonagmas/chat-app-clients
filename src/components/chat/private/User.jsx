      ...
      <div className="flex items-center justify-between gap-2 flex-[100%]">
        ...
        <div className="relative flex flex-col items-center justify-center">
          {props.manageGroup && (
            <div className="flex gap-2">
              <Badge
                badgeContent={props.newRequestData.length}
                color="secondary"
              ...
              return (
                ...
                >
                  ...
                  <p className="text-sm font-bold mx-2">
                    Group Name:{' '}
                    <span className="text-[#00aeff] font-extrabold">
                      {el.groupName}
                    </span>
                  </p>
                  ...
                  <div className="flex mx-2 my-2 gap-2 mt-4">
                    <button
                      ...
                      className="px-[90px] z-30 bg-[#00aeff] rounded-sm hover:text-gray-200 text-white font-bold"
                    >
                      Join
                    </button>
                  </div>
                  {props.joinHope && (
                    <div className="absolute z-40 h-52 bottom-[40px] bg-white py-1 w-60 flex items-center text-gray-500 font-bold mt-2">
                      You will join the chat one's the admin approves you
                      thanks.
                    </div>
                  )}
                </div>
          ...
          <div className="flex flex-col w-[100%] h-[100%] my-2 text-gray-500">
            {props.ownGroupList && (
              <div className="flex flex-col w-[100%] h-[100%] items-center justify-center">
                ...
                <img
                  src={props.currentGroup.groupPro}
                  alt="group"
                  className="h-[70%] w-[70%] rounded-sm mt-1"
                />{' '}
                <p className="font-bold mt-1 text-gray-500 text-sm">
                  Group Owner :{' '}
                  <span className="font-bold text-[#00aeff]">
                    {props.currentGroup.ownersName}
                  </span>
                </p>
                <button
                  onClick={() => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex items-center h-[100%] justify-between w-[70%]">
                                ...
                                {props.ownGroupData[0]?.ownersName ===
                                  el.userName && (
                                  <p className="mt-3 text-xs text-red-600 -ml-3 w-4 h-4">
                                    admin
                                  </p>
                                )}
                                {props.ownGroupData[0]?.ownersName !==
                                  ...
                                  <Close
                                    onClick={() =>
                                      props.deleteUserFromGroupHandler(el._id)
                                    }
                                    fontSize="small"
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <div className="flex items-center h-[100%] justify-between w-[70%]">
                                    ...
                                    <Add
                                      onClick={() =>
                                        props.addUsersToGroupHandler(el._id)
                                      }
                                      fontSize="small"
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex items-center h-[100%] justify-between w-[70%]">
                                ...
                                <Close
                                  onClick={() =>
                                    props.requestRejectHandler(el._id)
                                  }
                                  fontSize="small"
        ...
        <div className="absolute z-20 rounded-sm flex flex-col justify-center items-center border border-gray-300 w-auto px-4 h-[20%] bg-white shadow-lg shadow-black right-2 top-5">
          ...
          <div className="flex gap-3 justify-between mx-2 items-center my-2">
            ...
            {props.groupName?.length > 0 ? (
              ...
              <button
                disabled
                className="text-sm rounded-sm text-white px-8 mt-1 py-1 bg-[#59aacf]"
              >
                Create
              </button>
            )}
