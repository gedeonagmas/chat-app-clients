...
const Messages = ({ props }) => {
  ...
  return (
    <div className="overflow-y-scroll pt-2 pb-6 text-sm bg-white border border-gray-300  h-[83vh] w-[100%] ">
      {props.wellCome && (
        <div className="absolute z-10 flex flex-col items-center justify-center h-[82.5%] w-[99%] -mt-[8px]">
          <img
            src="./phone.jpg"
            alt="chat"
            className="h-72 w-[378px] rounded-sm mt-1"
          />
          <p className="text-lg font-extrabold text-[#00aeff] mt-1">
            well come to My chat dashboard
          </p>
          <p className="text-lg font-semibold text-[#00aeff]">
            click each users to chat with them
          </p>
        </div>
      )}
      {props.sayHi && (
        <div className="absolute bg-white flex flex-col items-center justify-center h-[50px] w-[99%] mt-[190px]">
          <p className="text-lg font-semibold text-gray-500">
            say <span className="font-bold text-[#00aeff]">hi</span> to your
            friends
          </p>
        </div>
      )}
        ...
        props.texts.map((el, i) => {
          return (
            <div key={el.time} className="">
              {el.content !== '' &&
                el.messageType === 'text' &&
                el.sender === props.currentUser.userName && (
                  <div
                    key={el.time}
                    className="w-[100%] mt-5 relative justify-end flex pr-3"
                  >
              ...
              {el.content !== '' &&
                ...
                el.sender !== props.currentUser.userName && (
                  <div
                    key={el.time}
                    className="w-[100%] pl-3 mt-5 mb-3 justify-start flex"
                  >
      ...
      {props.typing && (
        <p className="text-sm text-[#00aeff] ml-2 mt-1">typing...</p>
      )}
    </div>
  );
};
